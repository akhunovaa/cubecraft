...
import ru.mycubecraft.engine.graph.particles.IParticleEmitter;
import ru.mycubecraft.engine.graph.shadow.ShadowCascade;
import ru.mycubecraft.engine.graph.shadow.ShadowRenderer;
...
public class Renderer {
    ...
    public void init(Window window) throws Exception {
        ...
        bufferPassMesh = StaticMeshesLoader.load("assets/models/buffer_pass_mess.obj", "models")[0];
    }
    ...
    private void setupParticlesShader() throws Exception {
        ...
        particlesShaderProgram.createVertexShader(Utils.loadResource("assets/shaders/particles.glsl"));
        particlesShaderProgram.createFragmentShader(Utils.loadResource("assets/shaders/particles.glsl"));
    ...
    private void setupSkyBoxShader() throws Exception {
        ...
        skyBoxShaderProgram.createVertexShader(Utils.loadResource("assets/shaders/sb.glsl"));
        skyBoxShaderProgram.createFragmentShader(Utils.loadResource("assets/shaders/sb.glsl"));
    ...
    private void setupGeometryShader() throws Exception {
        ...
        gBufferShaderProgram.createVertexShader(Utils.loadResource("assets/shaders/gdbuffer.glsl"));
        gBufferShaderProgram.createFragmentShader(Utils.loadResource("assets/shaders/gdbuffer.glsl"));
    ...
    private void setupDirLightShader() throws Exception {
        ...
        dirLightShaderProgram.createVertexShader(Utils.loadResource("assets/shaders/dir_light.glsl"));
        dirLightShaderProgram.createFragmentShader(Utils.loadResource("assets/shaders/dir_light.glsl"));
    ...
    private void setupPointLightShader() throws Exception {
        ...
        pointLightShaderProgram.createVertexShader(Utils.loadResource("assets/shaders/point_light.glsl"));
        pointLightShaderProgram.createFragmentShader(Utils.loadResource("assets/shaders/point_light.glsl"));
    ...
    private void setupFogShader() throws Exception {
        ...
        fogShaderProgram.createVertexShader(Utils.loadResource("assets/shaders/fog.glsl"));
        fogShaderProgram.createFragmentShader(Utils.loadResource("assets/shaders/fog.glsl"));
