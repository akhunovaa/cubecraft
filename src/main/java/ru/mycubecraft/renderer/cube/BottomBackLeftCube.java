...
@Setter
public class BottomBackLeftCube extends Cube {

    private final static String DEFAULT_MODEL_FILE_PATH = "assets/models/cube_bottom_back_left.obj";
    ...
    public BottomBackLeftCube(String colour) {
        this.position = new Vector3f(0, 0, 0);
        this.scale = 1;
        this.rotation = new Vector3f(0, 0, 0);
